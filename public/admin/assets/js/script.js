...
if(revenueChart) {
  ...
  const daysInMonthPrevios = new Date(previousYear, previousMonth, 0).getDate();
  const days = daysInMonthCurrent > daysInMonthPrevios ? daysInMonthCurrent : daysInMonthPrevios;
  const arrayDay = [];
